...
### 2
Имаме масив с дължина 2n + 1. В него имаме n двойки от типа (k, k) и едно единствено число, което не образува такава двойка. Напишете функция, която намира това число.     
*Пример: 1, 2, 3, 2, 51, 1, 3 -> 51 е това число*
...
- Създава два нови - един съставен от нечетните елементи на arr и един от четните елементи на arr.
- Сортира двата нови масива
- Вмъква елементите на единия в другия без да разваля сортировката.
